...
No production data collection, database writes, queueing, live ATS/API calls, or
LinkedIn/Handshake collection are included. The current 4-track concentration
schema remains in place until the advisor confirms the project brief's fifth
track.
